...
CASE
      ...
      WHEN publication_country = "BE" AND Publication_type IN ("A",
      "A1", 
      "A2",
      "A3",                       
      "A6",
      ...
      --WHEN publication_country = "DE" AND Publication_type IN () THEN 'Granted Patent'
     ...
     WHEN publication_country = "ES" AND Publication_type IN ("B","B1",'A1',
      "B2",
      "R1",
      "R2",
      "T3",
      "T7") THEN 'Granted Patent'
...
--Latvia
  ...
  --Morocco
      ...
      --WHEN publication_country = "PT" AND Publication_type in ("T") THEN 'Utility Patent Application'
...
--Soviet Union
     -- WHEN publication_country = "SU" AND Publication_type IN ("A","A1","A2","A3","A4","B","C") THEN 'Granted Patent'
      ...
      WHEN publication_country = "US" AND Publication_type IN ("A",
      "B", 'B1', 'B2',                                                     
      "B3",
      "C1",
      "C2",
...
SELECT
    ...
    assignee_unique
FROM ai
WHERE patent_type = "Granted Patent"
GROUP BY 
    Simple_family_ID, 
    Priority_country,
    Document_ID_number,
